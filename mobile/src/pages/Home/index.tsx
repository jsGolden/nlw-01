...
const Home = () => {
    ...
    function handleNavigateToPoints() {
        if(selectedUF === "0" || selectedCity === "0") return Alert.alert("Oops...", "Preencha todas localidades!");
    ...
    function handleSelectedUf(itemValue: string | number) {
      setSelectedUf(String(itemValue));
    }

    function handleSelectedCity(itemValue: string | number) {
